...
<body>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <button type="button" data-toggle="modal" data-target="#confirmation" class="btn btn-primary">
                                                    Kirim
                                                </button>
                                            </div>
                                        </form>
    ...
    <div class="modal" id="confirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="storeSubmit" onclick="$('#btn-submit').click();">Iya</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        var countDownDate = new Date(`{{ date("Y-m-d H:i:s", strtotime($data['exam']->end_exam)) }}`.replace(/-/g, "/"))
            .getTime();
