                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" id="InputKtp" name="nik" class="form-control" placeholder="Misal : 31352629000243">
                                            </div>
                                            <div class="form-group col-md-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="company_fax" id="company_fax" placeholder="Misal : 03134325">
                                            </div>
                                        </div>
                                            <div class="form-group">
